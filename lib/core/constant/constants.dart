...
final admindashtitle =
    GoogleFonts.koHo(color: const Color.fromARGB(255, 0, 0, 0));
final recepeintdashcontent =
    GoogleFonts.koHo(color: const Color.fromARGB(255, 0, 0, 0), fontSize: 19);
